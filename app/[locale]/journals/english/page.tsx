...
export default function JournalsPage() {
    ...
    const fetchJournals = async () => {
        ...
        try {
            const result = await getJournals({
                ...
                page,
                limit,
                lang  // Always pass 'en' as the language
            });
    ...
    useEffect(() => {
        fetchJournals();
    }, [page, search]);  // Removed lang from dependencies since it's constant
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-3xl font-bold mb-8 text-center">Journals</h1>
